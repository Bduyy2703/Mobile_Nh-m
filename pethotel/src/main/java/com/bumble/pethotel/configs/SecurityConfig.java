...
import com.bumble.pethotel.security.JwtAuthenticationEntryPoint;
import com.bumble.pethotel.security.JwtAuthenticationFilter;
        ...
        SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http.csrf((csrf) -> csrf.disable())
                                ...
                                .authorizeHttpRequests((authorize) -> authorize
                                                ...
                                                .requestMatchers(HttpMethod.PUT, "/api/v1/payment/{orderId}")
                                                .permitAll()
